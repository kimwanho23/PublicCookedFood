...
@Table(name = "account_activity_log", indexes = {
        @Index(name = "idx_account_activity_account_regtime", columnList = "account_id, regTime"),
        @Index(name = "idx_account_activity_action_regtime", columnList = "action, regTime")
})
public class AccountActivityLog extends BaseTimeEntity {
    ...
    @Builder
    public AccountActivityLog(Long id, Account account, String action, String detail) {
        this.id = id;
